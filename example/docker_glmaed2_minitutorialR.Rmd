...
## Docker in R
**Please also open the run_docker_glmaed.R script to run a docker example in Rstudio, which automatically downloads files for a GLM run.**
